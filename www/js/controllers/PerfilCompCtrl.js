...
function PerfilCompCtrl($scope, $rootScope, $ionicPlatform, $timeout, $stateParams, ionicMaterialMotion, ionicMaterialInk, $firebaseObject, viaCEP, Utils, FireAuth, $cordovaImagePicker, $cordovaFile){
